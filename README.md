...
3. I learned how a screen works in general.  I thought all of the pixels came on the screen all at once, but now I realize we have to count through every single one and assigne it a color.  
...
2. some way to fix the debouncing problem?
